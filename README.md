...
Summary: Implementations of functions which have been introduced in R since version 3.0.0. The backports are conditionally exported which results in R resolving the function names to the version shipped with R (if available) and uses the implemented backports as fallback. This way package developers can make use of the new functions without worrying about the minimum required R version.
...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-backports-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-backports-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-backports-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-backports-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-backports-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-backports-feedstock/branch/master)
